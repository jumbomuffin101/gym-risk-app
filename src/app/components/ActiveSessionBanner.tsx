import { endWorkoutAction } from "@/app/workouts/actions";

export default function ActiveSessionBanner({ sessionId }: { sessionId: string }) {
  return (
    <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4 flex items-center justify-between">
      <div>
        ...
        <div className="font-medium text-zinc-100">Session in progress</div>
      </div>
